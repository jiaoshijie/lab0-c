...
{
    init_dut();
    t_init(t, DUDECT_TESTS);
    memset(percentiles, 0, sizeof(int64_t) * NUMBER_PERCENTILES);
}
...
static bool test_const(char *text, int mode)
{
    ...
    percentiles = malloc(sizeof(int64_t) * NUMBER_PERCENTILES);
